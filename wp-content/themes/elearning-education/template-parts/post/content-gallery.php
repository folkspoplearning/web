...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="page-box row">
    ...
    <div class="box-content">
      ...
      <p><?php $elearning_education_excerpt = get_the_excerpt(); echo esc_html( elearning_education_string_limit_words( $elearning_education_excerpt, esc_attr(get_theme_mod('elearning_education_excerpt_count','35')))); ?></p>
