	...
	if ( have_comments() ) : ?>
		<h2 class="comments-title">
			...
			if ( '1' === $elearning_education_comments_number ) {
				...
				printf( esc_html( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'elearning-education' ), esc_html( get_the_title() ) );
			} else {
				printf(
					esc_html(
					...
					esc_html ( number_format_i18n( $elearning_education_comments_number ) ),
