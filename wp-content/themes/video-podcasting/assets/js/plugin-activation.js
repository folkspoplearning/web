jQuery(document).ready(function($) {
    'use strict';
    var this_obj = video_podcasting_plugin_activate_plugin;
    ...
    $(document).on('click', '.video-podcasting-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message video-podcasting-plugin-install');
                button.addClass('button-primary video-podcasting-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.video-podcasting-recommended-plugins .video-podcasting-activation-note').css('display','block');
    ...
    $(document).on('click', '.video-podcasting-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .video-podcasting-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .video-podcasting-recommended-plugins').css('display','none');
    });
