...
class Video_Podcasting_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'video-podcasting' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $video_podcasting_font_awesome_icon_array = video_podcasting_font_awesome_icon_array();
                    foreach ($video_podcasting_font_awesome_icon_array as $video_podcasting_font_awesome_icon) {
                            $icon_class = $this->value() == $video_podcasting_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($video_podcasting_font_awesome_icon).'"></i>
                            <span class="video-podcasting-social-class">'.esc_attr($video_podcasting_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function video_podcasting_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'video-podcasting-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'video_podcasting_customizer_script' );

if(!function_exists('video_podcasting_font_awesome_icon_array')){
    function video_podcasting_font_awesome_icon_array(){
